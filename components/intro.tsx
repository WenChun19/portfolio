    ...
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://images.unsplash.com/photo-1682695799561-033f55f75b25?ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHwxfHx8ZW58MHx8fHx8&auto=format&fit=crop&w=400&q=60"
              alt="Ricardo"
              width="192"
              height="192"
              quality="95"
      ...
      >
        ...
        active:scale-105 transition hover:text-gray-950 cursor-pointer
        border-black/10"
